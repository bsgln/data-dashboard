...
const EXCEL_URL =
  "https://cdn.builder.io/o/assets%2F3a7659bd2c534c9d9609b01504a01464%2Ff59419d538b34c05be6399f805f52cf9?alt=media&token=e811fe30-9a2a-4cd7-b14f-89d904cc8374&apiKey=3a7659bd2c534c9d9609b01504a01464";
...
async function parseExcelToSurveyData(): Promise<SurveyDashboardData> {
  try {
    ...
    const question2: SurveyQuestion = {
      ...
      responses: [
        {
          category: "Эдийн засаг, үр ашиггүй зардал",
          votes: Math.round(17846 * 0.19),
          percentage: 19.0,
          color: colors[0],
        },
        {
          category: "Татвар, санхүүгийн бодлого",
          votes: Math.round(17846 * 0.15),
          percentage: 15.0,
          color: colors[1],
        },
        {
          category: "Төрийн алба, зардлын хэмнэлт",
          votes: Math.round(17846 * 0.14),
          percentage: 14.0,
          color: colors[2],
        },
        {
          category: "Эрүүл мэнд",
          votes: Math.round(17846 * 0.12),
          percentage: 12.0,
          color: colors[3],
        },
        {
          category: "Хууль сахиулах, хяналт",
          votes: Math.round(17846 * 0.1),
          percentage: 10.0,
          color: colors[4],
        },
        {
          category: "Дэд бүтэц, зам",
          votes: Math.round(17846 * 0.09),
          percentage: 9.0,
          color: colors[5],
        },
        {
          category: "Соёл, спорт",
          votes: Math.round(17846 * 0.08),
          percentage: 8.0,
          color: colors[6],
        },
        {
          category: "Хөдөө аж ахуй",
          votes: Math.round(17846 * 0.07),
          percentage: 7.0,
          color: colors[7],
        },
        {
          category: "Орон нутаг",
          votes: Math.round(17846 * 0.04),
          percentage: 4.0,
          color: colors[8],
        },
        {
          category: "Боловсрол",
          votes: Math.round(17846 * 0.02),
          percentage: 2.0,
          color: colors[9],
        },
      ],
    ...
    const question3: SurveyQuestion = {
      ...
      responses: [
        {
          category: "Төрийн зардал бууруулах",
          votes: Math.round(19435 * 0.22),
          percentage: 22.0,
          color: colors[0],
        },
        {
          category: "Төрийн өмчит компаниудын тоог цөөлөх",
          votes: Math.round(19435 * 0.17),
          percentage: 17.0,
          color: colors[1],
        },
        {
          category: "Халамжийн бодлогыг шинэчлэх",
          votes: Math.round(19435 * 0.15),
          percentage: 15.0,
          color: colors[2],
        },
        {
          category: "Төрийн албан хаагчдын тоо хязгаарлах",
          votes: Math.round(19435 * 0.12),
          percentage: 12.0,
          color: colors[3],
        },
        {
          category: "Чиг үүргийг хувийн хэвшилд шилжүүлэх",
          votes: Math.round(19435 * 0.1),
          percentage: 10.0,
          color: colors[4],
        },
        {
          category: "Төсөв оновчтой зарцуулах",
          votes: Math.round(19435 * 0.09),
          percentage: 9.0,
          color: colors[5],
        },
        {
          category: "Эдийн засгийн реформ",
          votes: Math.round(19435 * 0.06),
          percentage: 6.0,
          color: colors[6],
        },
        {
          category: "Ажлын байр нэмэгдүүлэх",
          votes: Math.round(19435 * 0.05),
          percentage: 5.0,
          color: colors[7],
        },
        {
          category: "Бусад",
          votes: Math.round(19435 * 0.03),
          percentage: 3.0,
          color: colors[8],
        },
      ],
    ...
    const question4: SurveyQuestion = {
      ...
      responses: [
        {
          category: "Соёлын байгууламж хасах",
          votes: Math.round(10537 * 0.25),
          percentage: 25.0,
          color: colors[0],
        },
        {
          category: "Дотуур байр, цэцэрлэг түр зогсоох",
          votes: Math.round(10537 * 0.2),
          percentage: 20.0,
          color: colors[1],
        },
        {
          category: "Инженерийн дэд бүтцийн зарим төсөл хасах",
          votes: Math.round(10537 * 0.15),
          percentage: 15.0,
          color: colors[2],
        },
        {
          category: "Сургуулийн шинэ барилга түр хойшлуулах",
          votes: Math.round(10537 * 0.12),
          percentage: 12.0,
          color: colors[3],
        },
        {
          category: "Эмнэлгийн зарим төсөл хасах",
          votes: Math.round(10537 * 0.1),
          percentage: 10.0,
          color: colors[4],
        },
        {
          category: "Цахилгаан, дулаан дэд бүтцийн өргөтгөл хасах",
          votes: Math.round(10537 * 0.08),
          percentage: 8.0,
          color: colors[5],
        },
        {
          category: "Бусад жижиг төсөл хасах",
          votes: Math.round(10537 * 0.05),
          percentage: 5.0,
          color: colors[6],
        },
        {
          category: "Үлдсэн санал",
          votes: Math.round(10537 * 0.05),
          percentage: 5.0,
          color: colors[7],
        },
    ...
    const question5: SurveyQuestion = {
      ...
      responses: [
        {
          category: "Татвар бууруулах",
          votes: Math.round(8428 * 0.28),
          percentage: 28.0,
          color: colors[0],
        },
        {
          category: "НӨАТ-ын өөрчлөлт",
          votes: Math.round(8428 * 0.22),
          percentage: 22.0,
          color: colors[1],
        },
        {
          category: "Татварын буцаан олголт, хөнгөлөлт",
          votes: Math.round(8428 * 0.16),
          percentage: 16.0,
          color: colors[2],
        },
        {
          category: "Татварын хугацааг уян хатан болгох",
          votes: Math.round(8428 * 0.12),
          percentage: 12.0,
          color: colors[3],
        },
        {
          category: "ЖДҮ дэмжих",
          votes: Math.round(8428 * 0.08),
          percentage: 8.0,
          color: colors[4],
        },
        {
          category: "Чөлөөт бүс хөгжүүлэх",
          votes: Math.round(8428 * 0.06),
          percentage: 6.0,
          color: colors[5],
        },
        {
          category: "Татварын урамшу��лал",
          votes: Math.round(8428 * 0.05),
          percentage: 5.0,
          color: colors[6],
        },
        {
          category: "Бусад",
          votes: Math.round(8428 * 0.03),
          percentage: 3.0,
          color: colors[7],
        },
      ],
    ...
    const question6: SurveyQuestion = {
      ...
      responses: [
        {
          category: "Дэд бүтцийн үйлчилгээ хувийн хэвшилд шилжүүлэх",
          votes: Math.round(6674 * 0.3),
          percentage: 30.0,
          color: colors[0],
        },
        {
          category: "Эрүүл мэндийн зарим үйлчилгээг хувийн хэвшилд шилжүүлэх",
          votes: Math.round(6674 * 0.24),
          percentage: 24.0,
          color: colors[1],
        },
        {
          category: "Халаалт, засвар үйлчилгээ хувийн хэвшилд",
          votes: Math.round(6674 * 0.14),
          percentage: 14.0,
          color: colors[2],
        },
        {
          category: "Харуул хамгаалалт, аюулгүй байдал хувийн хэвшилд",
          votes: Math.round(6674 * 0.12),
          percentage: 12.0,
          color: colors[3],
        },
        {
          category: "Тусгай хамгаалалттай газар нутгийн менежмент",
          votes: Math.round(6674 * 0.08),
          percentage: 8.0,
          color: colors[4],
        },
        {
    ...
    console.log(
      `✅ Created ${questions.length} questions with total ${totalVotesSum} votes`,
    );

    // Calculate metrics
    const dailyVotesAdded =
      await supabaseDailyTracker.updateDailyVoteCount(totalVotesSum);
    const now = new Date();
    ...
    return {
      ...
      genderDistribution: {
        male: {
          count: maleCount,
          percentage:
            Math.round((maleCount / totalGenderVotes) * 100 * 10) / 10,
        },
        female: {
          count: femaleCount,
          percentage:
            Math.round((femaleCount / totalGenderVotes) * 100 * 10) / 10,
        },
      },
      ageGroups,
